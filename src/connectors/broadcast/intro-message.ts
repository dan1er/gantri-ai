...
export const INTRO_MESSAGE = [
  ...
  '• _"Why don\'t NB and Porter match for January?"_ — I\'ll give you the exact order(s) that differ and why',
  '',
  '---',
  '',
  ...
  '',
  'When a question would benefit from a stable URL the whole team can revisit (WTD vs prior weeks, late orders snapshot, channel-level attribution breakdown, etc.), I can publish it as a Live Report. The data refreshes on every visit, the URL is bookmarkable, and you can change the date range from the page.',
  '',
  ...
  '• Per-order diff between Northbeam and Porter with cause classifier',
  ...
  '',
  '*✨ Worth knowing*',
  '• I cite sources on every answer (Northbeam, Porter, Grafana, GA4).',
