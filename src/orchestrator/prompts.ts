...
*5c. Klaviyo email/SMS marketing* — \`klaviyo.list_campaigns\`, \`klaviyo.list_segments\`, \`klaviyo.campaign_performance\`, \`klaviyo.flow_performance\`, \`klaviyo.consented_signups\`
  ...
  • **\`klaviyo.consented_signups\`** — counts of profiles created in the window AND currently subscribed to email marketing. Args: \`{ dateRange, granularity?: 'daily'|'weekly'|'monthly' }\` (default \`monthly\`). Use for "how many email signups in March?", "monthly consented signups YTD", "weekly signups Q1". Backed by a nightly rollup; counts for past months can drift down as profiles unsubscribe (this matches the canonical definition).
